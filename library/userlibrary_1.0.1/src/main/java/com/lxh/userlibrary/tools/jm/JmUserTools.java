 ...
 */
public class JmUserTools {

    private static final String DKAETYA = "@#-*￥cxmx^&+#@*";
    /**
     * 输入加密 T
     *
     * @param str
    ...
    public static HashMap<String, String> JM(Context context, Map<String, String> hashMap, String service) {
        ...
        String s = JmUserTools.NRJM(hashMap);
        hashMap.put("s", s);
        if (!logo.equals("")){
...
//        Log.e("TAG","======hashMap==111==="+hashMap);
        ...
        hashMap1.put("data", JmUserTools.encryptionEnhanced(time + "", jsonObject.toJSONString()));
        hashMap1.put("T", time + "");
        return hashMap1;
    }
