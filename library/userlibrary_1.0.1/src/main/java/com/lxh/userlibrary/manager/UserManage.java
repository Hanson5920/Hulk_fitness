...
import com.lxh.userlibrary.tools.jm.JmUserTools;
...
//                Log.e("TAG","====HTTP===onResponse========"+response);
                try {
                    ...
                    String data = JmUserTools.DecryptKey(jsonObject);
...
//                Log.e("TAG","====HTTP===onResponse========"+response);
    ...
    public static void UserChangeUser(String phone, String password, String name_type, String pass_type,
        ...
        if (!name_type_new.equals("")) {
            hashMap.put("name_type_new", name_type_new);//2为邮箱，3为手机
        }
        hashMap.put("mark_new", mark_new);//验证码:新账号收到的验证码
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_CHANGEUSER), userInterface);
    }
     ...
     * @param phone         账号：手机号码
     * @param password      密码:用户设置的密码
     * @param mark          验证码:用户手机接收的验证码
     * @param openid        三方平台对应唯一ID(用户第三方登录失败后注册才传此参数)  ---可选字段，如不需要此字段可传"";
     * @param open_type     4QQ，5微信，6微博(用户第三方登录失败后注册才传此参数)  ---可选字段，如不需要此字段可传"";
     * @param info_name     用户昵称
     * @param logo_url      用户第三方头像地址：第三方登录失败后注册才传此参数  ---可选字段，如不需要此字段可传"";
     * @param info_sex      用户性别：1男2女  ---可选字段，如不需要此字段可传"";
     * @param info_birthday 用户生日：YYYY-MM-DD格式  ---可选字段，如不需要此字段可传"";
     * @param info_desc     用户个性签名  ---可选字段，如不需要此字段可传"";
     * @param userInterface
     */
    public static void UserPhoneRigster(String phone, String password, String mark, String openid,
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_AUTHREG), userInterface);
    }
    ...
    public static void UserLogin(String name, String pass, String name_type,
        ...
        hashMap.put("pass_type", pass_type);//1是密码，2是验证码
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_LOGIN), userInterface);
    }
    ...
    public static void UserOAuthLogin(String openid, String open_type, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_LOGIN_OAUTH), userInterface);
    }
    ...
    public static void BindOAuthHasPhone(String openid, String open_type, String name, String pass,
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_BIND_OAUTH_HAS_PHONE), userInterface);
    }
    ...
    public static void BindOAuthNOPhone(String openid, String open_type, String name, String mark,
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_BIND_OAUTH_NO_PHONE), userInterface);
    }
...
//        Log.e("TAG","==选择保留用户信息==hashMap="+hashMap.toString());
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_SELECT_PHONE_OR_OAUTH), userInterface);
    }
    ...
    public static void UserLogout(String uid, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_LOGOUT), userInterface);
    }
    ...
    public static void UserSendMark(String name, UserInterface userInterface) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("name", name);//账号：手机号码/邮箱
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_SEND_MARK), userInterface);
    }
    ...
    public static void UserCheckMark(String name, String mark, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_CHECKMARK), userInterface);
    }
    ...
    public static void UserNewPassword(String name, String pass, String mark, String name_type, UserInterface userInterface) {
        ...
        hashMap.put("name_type", name_type);//2为邮箱，3为手机
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USER_NEWPASSWORD), userInterface);
    }
    ...
    public static void getUserInfo(String uid, String login_key, UserInterface userInterface) {
        ...
        hashMap.put("bstat", "1");
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USERINFO_INFO), userInterface);
    }
    ...
    public static void editUserInfo(String uid, String login_key, String logo, String name,
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.USERINFO_EDIT_INFO), userInterface);
    }
    ...
    public static void UserUploadLogo(String fileName, File file, String uid, String url, String logo, String login_key, UserInterface userInterface) {
        ...
        initUploadFile(fileName, file, JmUserTools.JM(getContext(), hashMap, AppServerUrl.USERINFO_UPLOAD_LOGO), userInterface);
    }
    ...
    public static void PayWeixin(String uid, String rmb, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.PAY_WEIXIN_MONEY), userInterface);
    }
    ...
    public static void PayAlipay(String uid, String rmb, UserInterface userInterface) {
        ...
        hashMap.put("uid", uid);//用户ID
        hashMap.put("rmb", rmb);//人民币(分)
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.PAY_ALIPAY_MONEY), userInterface);
    }
    ...
    public static void FollowSetUp(String uid, String fuid, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.FOLLOW_SETUP), userInterface);
    }
    ...
    public static void FollowSetDown(String uid, String fuid, UserInterface userInterface) {
        ...
        hashMap.put("uid", uid);//用户ID(关注者)
        hashMap.put("fuid", fuid);//被关注者ID
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.FOLLOW_SETDOWN), userInterface);
    }
    ...
    public static void FollowGetRecommend(String uid, String limit, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.FOLLOW_GETRECOMMEND), userInterface);
    }
    ...
    public static void FollowGetTop(String uid, String myid, String page, String limit, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.FOLLOW_GETTOP), userInterface);
    }
     ...
     *
     * @param uid           用户ID
     * @param myid          当前用户ID，用于表示是否我已经关注了!
     * @param page          第几页
     * @param limit         每页多少条
     * @param userInterface
     */
    public static void FollowGetUnder(String uid, String myid, String page, String limit, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.FOLLOW_GETUNDER), userInterface);
    }
    ...
    public static void MoneyGet(String uid, UserInterface userInterface) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("uid", uid);//用户ID
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.MONEY_GET), userInterface);
    }
    ...
    public static void MoneyGetCostDetail(String uid, String page, String limit, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.MONEY_GET_COST_DETAIL), userInterface);
    }
    ...
    public static void MoneySetLess(String uid, String num, String content, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.MONEY_SET_LESS), userInterface);
    }
    ...
    public static void CommitSetUp(String uid, String pid, String theme_type, String theme_id, String content, String login_key, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.COMMIT_SETUP), userInterface);
    }
    ...
    public static void CommitGetByTheme(String theme_type, String theme_id, String page, String limit, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.COMMIT_GETBYTHEME), userInterface);
    }
    ...
    public static void CommitGetByUid(String uid, String page, String limit, UserInterface userInterface) {
        ...
        initHttp(JmUserTools.JM(getContext(), hashMap, AppServerUrl.COMMIT_GETBYUID), userInterface);
    }
